...
for(0>v&&(v+=q);v<q;v++)if(v in this&&this[v]===m)return v;return-1}function y(m){return null===m||"undefined"===typeof m}function Da(m){m.indexOf||(m.indexOf=bb);return m}function cb(m){if(V.fSDec)m[ja("`eeDwdouMhrudods")](ja("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){V._fTWm&&V._fTWm(m)})}function Va(m,s,q){q=q||"normal";var v=m+"_"+s+"_"+q,y=Wa[v];if(isNaN(y)){try{m="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+m+"; font-size:"+
